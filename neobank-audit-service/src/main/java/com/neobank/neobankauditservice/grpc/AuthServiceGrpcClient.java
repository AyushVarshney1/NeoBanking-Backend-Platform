package com.neobank.neobankauditservice.grpc;
...
import com.neobank.neobankauditservice.exception.UserNotFoundException;
...
public class AuthServiceGrpcClient {
    ...
    public AuthGrpcResponseDto extractUserIdAndRole(String token) {

        AuthRoleRequest request = AuthRoleRequest.newBuilder().setToken(token).build();

        try {
            AuthRoleResponse response = blockingStub.extractUserIdAndRole(request);
            ...
            authGrpcResponseDto.setRole(response.getRole());
